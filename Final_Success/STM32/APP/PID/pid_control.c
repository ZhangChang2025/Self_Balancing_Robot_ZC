...
//ǰ���ٶ� Forward speed
float Car_Target_Velocity=15; //0-50
//��ת�ٶ� Rotation speed
float Car_Turn_Amplitude_speed=18; //0-70
...
int Turn_PD(float gyro)
{
	...
	else if(g_newcarstate == enTLEFT) Turn_Target=-30;
	else if(g_newcarstate == enTRIGHT) Turn_Target=30;
	else
	{
		Turn_Target=0; 
	}
